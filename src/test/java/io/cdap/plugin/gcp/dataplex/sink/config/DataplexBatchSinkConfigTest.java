...
public class DataplexBatchSinkConfigTest {
  ...
  public void testConstructor() {
    ...
    assertNull(config.getContentType("format"));
    assertNotNull(config.getRangeEnd());
    assertNotNull(config.getRangeInterval());
    assertNotNull(config.getRangeStart());
    assertTrue(config.isUpdateDataplexMetadata());
    assertTrue(config.isRequirePartitionField());
  }

  @Test
  public void testPartitionFilterNull() {
    DataplexBatchSinkConfig config = getBuilder().setPartitionFilter(null).build();
    assertNull(config.getPartitionFilter());
  }
